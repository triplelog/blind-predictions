...
for i in range(0,len(lines)):
	...
	if line[:len(startState)] == startState:
		line = '<g id="state-'+states[idx]+'" fill="none" stroke="#000000" stroke-opacity="1" stroke-width="3.07087" stroke-linecap="square" stroke-linejoin="bevel" transform="matrix(1,0,0,1,105.651,45.8515)"'
