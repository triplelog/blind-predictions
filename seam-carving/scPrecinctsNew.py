...
for pixel in pixelMap.keys():
	...
	line = "p.x = "+str(pixelMap[pixel]['x'])+"; p.y = "+str(pixelMap[pixel]['y'])+"; p.county = "+str(pixelMap[pixel]['county'])+"; p.val = "+str(pixelMap[pixel]['d']+pixelMap[pixel]['r'])+"; p.data[\"d\"] = "+str(pixelMap[pixel]['d'])+"; p.data[\"r\"] = "+str(pixelMap[pixel]['r'])+"; p.data[\"d16\"] = "+str(pixelMap[pixel]['d16'])+"; p.data[\"r16\"] = "+str(pixelMap[pixel]['r16'])+";\n"
