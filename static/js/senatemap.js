	...
	if (Object.keys(senateData)[i] != 'dc'){
		if (senateData[Object.keys(senateData)[i]][2014].length>0) {
			...
			if (senateData[Object.keys(senateData)[i]]['pres16']>.5){
				document.getElementById(Object.keys(senateData)[i].toUpperCase()+'-outer1').style.fill = 'red';
			}
			else {
				document.getElementById(Object.keys(senateData)[i].toUpperCase()+'-outer1').style.fill = 'blue';
			}
			...
			if (senateData[Object.keys(senateData)[i]][2014][0]>.5){
				document.getElementById(Object.keys(senateData)[i].toUpperCase()+'-outer3').style.fill = 'red';
				document.getElementById(Object.keys(senateData)[i].toUpperCase()+'-inner').style.fillOpacity = '1';
				document.getElementById(Object.keys(senateData)[i].toUpperCase()+'-inner').style.fill = 'red';
			}
			else if (senateData[Object.keys(senateData)[i]][2014][0]<.5){
				document.getElementById(Object.keys(senateData)[i].toUpperCase()+'-outer3').style.fill = 'blue';
				document.getElementById(Object.keys(senateData)[i].toUpperCase()+'-inner').style.fillOpacity = '1';
				document.getElementById(Object.keys(senateData)[i].toUpperCase()+'-inner').style.fill = 'blue';
			}
			document.getElementById(Object.keys(senateData)[i].toUpperCase()+'-outer1').style.fillOpacity = .1+1.5*Math.pow(Math.pow((.5-senateData[Object.keys(senateData)[i]]['pres16']),2),.2);
			document.getElementById(Object.keys(senateData)[i].toUpperCase()+'-outer2').style.fillOpacity = .1+1.5*Math.pow(Math.pow((.5-senateData[Object.keys(senateData)[i]]['pres12']),2),.2);
			document.getElementById(Object.keys(senateData)[i].toUpperCase()+'-outer3').style.fillOpacity = .1+1.5*Math.pow(Math.pow((.5-senateData[Object.keys(senateData)[i]][2014][0]),2),.2);
		}
		else {
			document.getElementById(Object.keys(senateData)[i].toUpperCase()+'-inner').style.fillOpacity = '1';
